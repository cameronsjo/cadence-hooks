...
/// nor a resolvable home directory is set, matching the prior HOME-only
/// gate; the actual path construction (tilde expansion, comma-list) always
/// runs through the shared resolver.
