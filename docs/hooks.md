...
Measured on Claude Code 2.1.273 (2026-09-15) with a throwaway `--settings` file whose hooks only logged which filters matched, against a catch-all hook that refused every command so nothing executed:
